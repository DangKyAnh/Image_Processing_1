...
namespace HSI_01
{
    public partial class Chuyen_doi_khong_gian_mau_HSI : Form
    {
        ...
        {
            InitializeComponent();
            String file_path = @"C:\Users\user\Desktop\Image_Processing\Week_8\C#\Anh_01.jpg";
        ...
        public List<Bitmap> Function_HSI(Bitmap Anh)
        {
            ...
            Bitmap Anh_V = new Bitmap(Anh_1, Anh_1.Size);
            Bitmap Anh_HSV = new Bitmap(Anh_1, Anh_1.Size);
            int x, y;
            for (x = 0; x < Anh_1.Height; x++)
            {
                for (y = 0; y < Anh_1.Width; y++)
                {
                    ...
                    double V_ = Math.Min(R, Math.Min(G, B));

                    Anh_H.SetPixel(x, y, Color.FromArgb((Byte)H_, (Byte)H_, (Byte)H_ ));
                    Anh_S.SetPixel(x, y, Color.FromArgb((Byte)S_, (Byte)S_, (Byte)S_));
                    Anh_V.SetPixel(x, y, Color.FromArgb((Byte)V_, (Byte)V_, (Byte)V_));
                    Anh_HSV.SetPixel(x, y, Color.FromArgb((Byte)H_, (Byte)S_, (Byte)V_));
